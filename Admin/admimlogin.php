...
<tr><td class="lefttd">User Name</td><td><input type="text" name="username" /></td></tr>
<tr><td class="lefttd">Password</td><td><input type="password"name="pwd" /></td></tr>


<tr><td>&nbsp;</td><td><input type="submit" value="Log In" name="sub"  onclick="index.php"; style="border:0px; background:linear-gradient(#900,#D50000); width:100px; height:30px; border-radius:10px 1px 10px 1px; box-shadow:1px 1px 5px black; color:white; font-weight:bold; font-size:14px; text-shadow:1px 1px 6px black; "></td></tr>
...
$a=$_POST['username'];
$b=$_POST['pwd']; 
$h="select * from users where username='$a' and pwd='$b'";
$hs=mysql_query($h);
